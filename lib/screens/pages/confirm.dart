                  ...
                  children: [
                                  ...
                                  Column(
                                    children: [
                                      ...
                                      AppText(
                                        ...
                                        colour: Colors.black54.withOpacity(0.6),
                                      ),
                                      AppText(
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(width: 1, color: Colors.black87.withOpacity(0.4)),
                        color: Colors.white,
                      ),
                      child: Row(
                        ...
                        children: [
                          Text(
                            "Amount You Pay: ",
                            style:
                                TextStyle(fontSize: size.width * 0.04, color: Colors.black87.withOpacity(0.6)),
                          ),
                          SizedBox(
                          ...
                          Text(
                            amount,
                            style: TextStyle(
                                fontSize: size.width * 0.045, color: AppColours.buttoncolor.withOpacity(0.9), fontWeight: FontWeight.w600),
                          ),
                        ],
                      ),
                    ),
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(8),
                        border: Border.all(width: 1, color: Colors.black54.withOpacity(0.4)),
                        color: Colors.white,
                      ),
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.start,
